...
const FileMessage = ({ message, isOwnMessage }) => {
  ...
  if (!file || !file.url) {
    return (
      <div
        className={`max-w-xs p-3 rounded-lg border border-red-200 bg-red-50`}
      >
    ...
    return (
      <div className="max-w-[280px] sm:max-w-sm">
        ...
        <div className="mt-1 sm:mt-2 px-1 sm:px-2">
          <p className="text-xs text-black truncate">{content}</p>
          {file.size && (
  ...
  return (
    <div
      className={`max-w-[280px] sm:max-w-xs p-3 sm:p-4 rounded-lg border shadow-sm ${
        isOwnMessage ? "bg-white border-rose-200" : "bg-gray-50 border-gray-200"
      }`}
    >
